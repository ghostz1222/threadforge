  ...
  return (
    <div className="rounded-xl border border-white/[0.06] bg-coal-900/40 p-4">
      <div className="flex items-center justify-between">
        <span className="font-mono text-[11px] uppercase tracking-[0.2em] text-white/40">Design Credits</span>
      ...
      <p className="mt-2 text-[11px] text-white/40">
        {emailUnlocked
          ? "Email tier: up to 20 designs/day"
          : left > 0
            ? `${left} free design${left === 1 ? "" : "s"} remaining`
